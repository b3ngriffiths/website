---
title: "Thresholds: The Word Missing from Labour's Manifesto"
date: 2025-11-27
draft: false
description: "Labour froze tax rates but not tax thresholds. That technicality is dragging millions into higher tax bands. Brief analysis of fiscal drag and what it means for your payslip."
tags: ["budget", "tax"]
categories: ["Finance"]
---
...
Take the median full-time worker earning £39,000 (according to the ONS). Their effective tax rate is 21.7% today. By 2031, after six years of 3% salary raises, they'll pay 23.4%. That's roughly £2,665 more in total tax over that period, even though the rates never moved.
...
A year later, she extended the freeze to 2031 and claimed to have kept "every single one" of Labour's manifesto commitments.  That directly contradicts what she implied last year.  What's changed? Nothing.  The manifesto never mentioned thresholds in the first place, so she's dancing on a technicality.

The IFS isn't buying it either. Their response to the 2025 Budget was blunt: extending the freeze on National Insurance thresholds "breaches the government's manifesto tax promise not to increase National Insurance."

The income tax position is muddy. The manifesto technically only promised not to raise "rates", and the rates haven't changed. But fiscal drag doesn't care about semantics. When thresholds stay fixed and salaries rise, more of our income gets taxed at higher rates. The effect is identical to increasing rates, even if the mechanism isn't.    
...
|         £12,570 |  0.0% |  0.9% |  1.8% |  2.7% |  3.6% |  4.4% |  5.2% | +5.2pp [^1] |
...
_Note: this table ignores bigger impact from child benefit and free childcare thresholds. [^2]_

[^1]: £12,570 starter shows the largest proportional increase, they start at the personal allowance threshold, so even small salary growth makes them a taxpayer.
[^2]: The High Income Child Benefit Charge starts at £60,000; free childcare eligibility ends at £100,000. Both are frozen. As more families drift into these zones through salary growth alone, they face effective tax rates far higher than the tables above suggest, losing benefits worth up to £2,501 annually (for two children) or £10,000+ in childcare support, while rates technically stay unchanged.

## The Scale   
The Office for Budget Responsibility (OBR) doesn't deal in technicalities. Their projections are blunt: by 2030-31, the threshold freeze will:
...
![OBR-Effect of threshold freezes on additional taxpayers and tax receipts](OBR-effect-of-threshold-freezes.png#center)
